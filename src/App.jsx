        ...
        <div className="generator">
          ...
          <div className="generator__password">
            ...
            <button className="copy__btn">
              <FontAwesomeIcon icon={faClipboard} onClick={handleCopyPassword} />
            </button>
          </div>
          <div className="form-group">
          <div className="label-wrapper">
            <label htmlFor="password-strength" className="lnum">
              Password length
            </label>
            </div>            
            <div className="custom-num">
              <FontAwesomeIcon icon={faArrowUp} className='arrow-icon' onClick={() => setPasswordLength(prev => Math.min(prev + 1, 26))} />
              <input
                className="pw"
                ...
                min="8"
              />
              <FontAwesomeIcon icon={faArrowDown} className='arrow-icon' onClick={() => setPasswordLength(prev => Math.max(prev - 1, 8))} />
            </div>
          </div>
          <div className="form-group">
